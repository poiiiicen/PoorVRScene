...
object Scene {
    ...
    val leftCamera = Camera(floatArrayOf(-8.0f, 0.0f, 10.0f), floatArrayOf(-8.0f, 0.0f, 0.0f), floatArrayOf(0.0f, 1.0f, 0.0f))
    val rightCamera = Camera(floatArrayOf(8.0f, 0.0f, 10.0f), floatArrayOf(8.0f, 0.0f, 0.0f), floatArrayOf(0.0f, 1.0f, 0.0f))
