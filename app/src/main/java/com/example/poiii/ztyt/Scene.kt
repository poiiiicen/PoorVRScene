...
object Scene {
    ...
    val leftCamera = Camera(floatArrayOf(-0.5f, -4.0f, 0.0f), floatArrayOf(-0.5f, -4.0f, 1.0f), floatArrayOf(0.0f, 1.0f, 0.0f))
    val rightCamera = Camera(floatArrayOf(0.5f, -4.0f, 0.0f), floatArrayOf(0.5f, -4.0f, 1.0f), floatArrayOf(0.0f, 1.0f, 0.0f))
